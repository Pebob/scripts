        ...
        widgets.ResizingPanel{
            ...
            subviews={
                ...
                widgets.TooltipLabel{
                    ...
                    show_tooltip=true
                    -- text_pen=--function() return if self.success then COLOR_GREEN else COLOR_RED end end
...
function PregnancyGui:success()
    if self.success then return COLOR_GREEN
